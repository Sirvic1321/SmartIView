import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, f as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, r as renderComponent, m as maybeRenderHead, d as addAttribute, c as createAstro, i as renderHead, e as renderSlot, j as renderScript } from './astro/server_DoXUFCOZ.mjs';
import 'kleur/colors';
import 'clsx';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DpThpQUH.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/SmartIView-mini/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://sirvic1321.github.io/SmartIView-mini/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DXUiv2J6.mjs').then(n => n._);
...
<div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
  <div class="mb-10 w-full">
    <h4 class="mb-9 text-lg font-semibold text-white">{footerLinks[3].header}</h4>
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="ud-header absolute top-0 left-0 z-40 flex w-full items-center bg-transparent"> <div class="container"> <div class="relative -mx-4 flex items-center justify-between"> <div class="w-60 max-w-full px-4"> <a href="/" class="navbar-logo block w-full py-5"> ${Astro2.url.pathname === "/" ? renderTemplate`<img src="/assets/logo/logo-white.png" alt="SmartIView Logo" class="header-logo w-full">` : renderTemplate`<img src="/assets/logo/logo-white.png" alt="logo" class="w-full dark:hidden">
            <img src="/assets/logo/logo-white.png" alt="logo" class="w-full hidden dark:block">`} </a> </div> <div class="flex w-full items-center justify-between px-4"> <div> <button id="navbarToggler" class="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-primary focus:ring-2 lg:hidden"> <span class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span> <span class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span> <span class="relative my-[6px] block h-[2px] w-[30px] bg-dark dark:bg-white"></span> </button> <nav id="navbarCollapse" class="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white dark:bg-dark-2 py-5 shadow-lg lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent dark:lg:bg-transparent lg:py-0 xl:px-4 lg:shadow-none 2xl:px-6"> <ul class="block lg:flex 2xl:ml-20"> ${menuitems.map((item, index) => {
    if (!item.children) {
...
</header>--></div></div></div></div></div></header>`;
}, "C:/Users/TMS/SmartIView/src/components/layout/Header.astro", void 0);
...
}, "C:/Users/TMS/SmartIView/src/components/layout/BackToTop.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/site.webmanifest"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(image, "content")}><meta property="twitter:image"${addAttribute(image, "content")}><title>${title}</title>${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <!-- <Header client:load /> --> <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} <!-- Footer added here --> ${renderComponent($$result, "BackToTop", $$BackToTop, {})} <!-- Comment out the MadeWithButton component --> <!--<MadeWithButton /> -->  ${renderScript($$result, "C:/Users/TMS/SmartIView/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "C:/Users/TMS/SmartIView/src/layouts/Layout.astro", void 0);

export { $$Layout as $, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, DEFAULT_HASH_PROPS as a, getCollection as g };
